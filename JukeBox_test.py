...
class TestPlaylist(unittest.TestCase):
    ...
    def test_delete_track(self):
        self.playlist.tracks.append(self.track2)
        self.playlist.tracks.append(self.track1)
        self.playlist.tracks.remove(self.track1)
        self.assertNotIn(self.track1, self.playlist.tracks)
...
class TestMusicPlayer(unittest.TestCase):
    ...
    def test_play_pause_music(self):
